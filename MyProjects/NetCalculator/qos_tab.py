from PyQt5.QtWidgets import QWidget, QVBoxLayout, QTableWidget, QTableWidgetItem, QHeaderView, QLineEdit, QHBoxLayout, QLabel
    ...
    def generate_qos_data(self):
        ...
        for class_num in range(1, 5):  # Классы AF1–AF4
            for drop_prob in range(1, 4):  # Уровни надежности (1–3)
                ...
                ds_field_bin = f"{(class_num << 3 | drop_prob):06b}"  # Бинарное значение DS Field
                ds_field_dec = int(ds_field_bin, 2)  # Десятичное значение DS Field
                ...
                qos_data.append((
                    ...
                    str(tos_precedence), tos_hex, str(tos_dec), tos_bin,
        ...
        ef_tos_precedence = 5 * 8  # Приоритет TOS для EF
        ...
        qos_data.append((
            ...
            str(ef_tos_precedence), ef_tos_hex, str(ef_tos_dec), ef_tos_bin,
        ...
        qos_data.append((
            ...
            str(be_tos_precedence), be_tos_hex, str(be_tos_dec), be_tos_bin,
