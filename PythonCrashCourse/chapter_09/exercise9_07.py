...
class Admin(User):
    ...
    def __init__(self, first_name, last_name, user_id, group_name, privileges):
...
admin = Admin('root', '', '0', 'wheel', '«разрешено добавлять сообщения», «разрешено удалять пользователей», «разрешено банить пользователей»')
